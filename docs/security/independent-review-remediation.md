...
|  39 | Mandatory CI/protection         | Partial                    | CI, immutable action SHAs, CodeQL SAST and Gitleaks are active; repository owner explicitly removed CODEOWNERS. Branch rules, cargo audit and required approvals remain externally configured.   |
|  40 | Reproducible releases           | Partial                    | Changelog added; tags, provenance, deployed SHA, rollback and manifest remain.                                                                                                                   |
|  41 | Supply-chain controls           | Partial                    | Lockfile/dependency review, immutable action SHAs and secret scan remain; repository owner explicitly disabled Dependabot. SBOM, license checks and attestations remain.                         |
