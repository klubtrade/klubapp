...
|  39 | Mandatory CI/protection         | Partial                    | CI, CODEOWNERS, immutable action SHAs, CodeQL SAST and Gitleaks added; branch rules, cargo audit and required approvals remain externally configured.                                            |
|  40 | Reproducible releases           | Partial                    | Changelog added; tags, provenance, deployed SHA, rollback and manifest remain.                                                                                                                   |
|  41 | Supply-chain controls           | Partial                    | Lockfile/dependency review, Dependabot for npm/Cargo/actions, immutable action SHAs and secret scan added; SBOM, license checks and attestations remain.                                         |
